...
Download `downloads/ControlledYOLO-2.0.4.zip`, extract it, and run `Install.cmd`. The adjacent `.sha256` file contains its checksum. The copy-paste bootstrap is in `docs/BOOTSTRAP.txt`.
