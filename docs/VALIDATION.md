...
Live acceptance succeeded on 2.0.6: InspectOnly recognized the waiting quoted Python download_images.py review_images3.json card. After resuming, the monitor invoked it and Codex recorded ExecApproval/Approved at 2026-09-06 11:23:09 UTC. The matching request became allowed_by_ui, disappeared from attention, and remained quiet through subsequent scans. Final verification at 11:23:41 UTC showed version 2.0.6, unpaused, all three UE5 workers selected, fresh heartbeat and scan, and zero attention. Installed files match the verified package. All 46 tests passed on the PC, including 16 layout and six header cases; Windows CI and standalone packaging passed at https://github.com/arjunyerevan95-dot/ControlledYOLO/actions/runs/34030045370 .

Immutable source package: commit 1295f39e4091330309f01e25147b5636bda9fcdc, downloads/ControlledYOLO-2.0.6.zip, SHA256 5956d2165741c65c5c343005b9a7240142d3411736b9e2d32bf9882127f31a2a. Native events remain unobserved. Unbound floating preview cards and hidden chats are not covered, and end-to-end focus retention is not established. No other chats were selected and no global permission policy was changed.
